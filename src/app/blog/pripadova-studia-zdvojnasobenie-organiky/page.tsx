        ...
        <div className="bg-space text-light">
            <header className="relative bg-galaxy py-20 sm:py-32">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    >
                         <p className="text-aurora font-semibold">Prípadová Štúdia</p>
                        <h1 className="text-4xl md:text-6xl font-bold my-4 text-light font-headline">Zdvojnásobenie organickej návštevnosti pre e-shop s módou</h1>
            ...
            <main className="container mx-auto py-16 px-4">
                 <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 my-16">
                        {kpi.map((item, index) => (
                             <Card key={index} className="bg-galaxy/50 border-spaceship text-center p-6">
                                <p className="text-4xl font-bold text-aurora">{item.value}</p>
                                <p className="font-semibold text-light mt-2">{item.label}</p>
                                <p className="text-sm text-rocket mt-1">{item.description}</p>
                            </Card>
                        ))}
                    </div>

                    <div className="prose prose-lg dark:prose-invert text-light/90 max-w-none">
                        <h2 className="text-aurora">Klient a Východisková Situácia</h2>
                        <p>
                        ...
                        <h2 className="text-aurora">Naša Stratégia a Postup</h2>
                        ...
                        <h2 className="text-aurora">Výsledky a Záver</h2>
                        <p>
                        ...
                        <p>
                           Máte podobné výzvy? Nechajte si od nás urobiť <Link href="/seo-audit-akcia" className="text-sky hover:underline">nezáväzný SEO audit</Link> a zistite, kde sa skrýva váš rastový potenciál.
                        </p>

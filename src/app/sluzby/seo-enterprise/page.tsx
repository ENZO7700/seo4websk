               ...
               <section className="grid items-center gap-12 md:grid-cols-2 mb-20">
                ...
                <section className="mb-20">
                     <Card className="bg-card border">
                        <CardHeader>
                            <CardTitle className="text-2xl md:text-3xl font-bold text-center text-foreground">Neobmedzené možnosti s Enterprise</CardTitle>
                        </CardHeader>
                        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-lg pt-6">
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Všetko z balíka Korporát</h3>
                             ...
                             <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Medzinárodné SEO</h3>
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Dedikovaný SEO manažér a tím</h3>
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Školenia pre váš tím</h3>
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Kompletné prepojenie s biznis cieľmi</h3>
                ...
                <section className="max-w-4xl mx-auto mb-20">
                    ...
                    <ol className="relative border-l border-border">                  
                        <li className="mb-10 ml-6">            
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold text-foreground">Strategické partnerstvo a R&D</h3>
                        ...
                        <li className="mb-10 ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-foreground">Plná integrácia s vašimi tímami</h3>
                            <p className="text-base font-normal text-muted-foreground">Náš dedikovaný manažér zabezpečuje bezproblémovú komunikáciu a spoluprácu s vašimi internými oddeleniami (marketing, IT, produkt, predaj).</p>
                        </li>
                        <li className="ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-foreground">Reporting pre manažment a Board</h3>
                            <p className="text-base font-normal text-muted-foreground">Pravidelne pripravujeme a prezentujeme strategické reporty pre vedenie spoločnosti, ktoré jasne preukazujú prínos a návratnosť investícií do SEO.</p>
                        </li>
                    </ol>
                </section>

                 <section id="cta" className="bg-card rounded-lg p-12 text-center border">
                     <h2 className="text-3xl font-bold mb-4 font-headline text-foreground">Poďme spoločne definovať budúcnosť vášho úspechu.</h2>

        ...
        <div className="bg-space text-light">
             <header className="bg-galaxy py-20 sm:py-32">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-4 text-light font-headline">SEO Balík: Enterprise</h1>
               ...
               <section className="grid items-center gap-12 md:grid-cols-2 mb-20">
                ...
                <section className="mb-20">
                     <Card className="bg-galaxy border-spaceship">
                        <CardHeader>
                            <CardTitle className="text-2xl md:text-3xl font-bold text-center text-light">Neobmedzené možnosti s Enterprise</CardTitle>
                        </CardHeader>
                        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-lg pt-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-rocket">Absolútne komplexný servis ako východiskový bod, ktorý ďalej prispôsobujeme a rozširujeme podľa vašich potrieb.</p>
                                </div>
                            </div>
                             <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Medzinárodné SEO</h3>
                                    <p className="text-sm text-rocket">Kompletná stratégia a exekúcia pre expanziu na zahraničné trhy (analýza trhu, hreflang, geo-targeting, lokalizácia obsahu a i.).</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Dedikovaný SEO manažér a tím</h3>
                                    <p className="text-sm text-rocket">Váš vlastný tím expertov, ktorý pozná váš biznis do hĺbky a je vám plne k dispozícii pre operatívne aj strategické potreby.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Školenia pre váš tím</h3>
                                    <p className="text-sm text-rocket">Zvýšime SEO znalosti vášho interného marketingového, obsahového alebo vývojového tímu prostredníctvom workshopov na mieru.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Kompletné prepojenie s biznis cieľmi</h3>
                                    <p className="text-sm text-rocket">Reportujeme priamo na kľúčové biznis metriky, ktoré sú dôležité pre váš manažment (PNO, ROI, LTV, Market Share).</p>
                                </div>
                            </div>
                             <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                ...
                <section className="max-w-4xl mx-auto mb-20">
                    ...
                    <ol className="relative border-l border-spaceship">                  
                        <li className="mb-10 ml-6">            
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold text-light">Strategické partnerstvo a R&D</h3>
                        ...
                        <li className="mb-10 ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-light">Plná integrácia s vašimi tímami</h3>
                            <p className="text-base font-normal text-rocket">Náš dedikovaný manažér zabezpečuje bezproblémovú komunikáciu a spoluprácu s vašimi internými oddeleniami (marketing, IT, produkt, predaj).</p>
                        </li>
                        <li className="ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-light">Reporting pre manažment a Board</h3>
                            <p className="text-base font-normal text-rocket">Pravidelne pripravujeme a prezentujeme strategické reporty pre vedenie spoločnosti, ktoré jasne preukazujú prínos a návratnosť investícií do SEO.</p>
                        </li>
                    </ol>
                </section>

                 <section id="cta" className="bg-galaxy rounded-lg p-12 text-center border border-spaceship">
                     <h2 className="text-3xl font-bold mb-4 font-headline text-light">Poďme spoločne definovať budúcnosť vášho úspechu.</h2>

               ...
               <section className="grid items-center gap-12 md:grid-cols-2 mb-20">
                ...
                <section className="mb-20">
                     <Card className="bg-card border">
                        <CardHeader>
                            <CardTitle className="text-2xl md:text-3xl font-bold text-center text-foreground">Čo presne získate?</CardTitle>
                        </CardHeader>
                        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-lg pt-6">
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Analýza kľúčových slov (do 20)</h3>
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Základný SEO audit</h3>
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">On-page optimalizácia (5 stránok)</h3>
                            ...
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Mesačný report</h3>
                 ...
                 <section className="max-w-4xl mx-auto mb-20">
                    ...
                    <ol className="relative border-l border-border">                  
                        <li className="mb-10 ml-6">            
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold text-foreground">Úvodná analýza a Kick-off</h3>
                            <p className="mb-4 text-base font-normal text-muted-foreground">Na úvodnom stretnutí si prejdeme vaše ciele a spravíme základný audit a analýzu kľúčových slov, aby sme vedeli, kde začať.</p>
                        </li>
                        <li className="mb-10 ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-foreground">Mesačná optimalizácia</h3>
                            <p className="text-base font-normal text-muted-foreground">Každý mesiac sa zameriame na implementáciu odporúčaní z auditu a postupnú on-page optimalizáciu podľa dohodnutého plánu.</p>
                        </li>
                        <li className="ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-foreground">Reporting a Konzultácie</h3>
                            <p className="text-base font-normal text-muted-foreground">Na konci mesiaca dostanete report s výsledkami a v prípade potreby si môžeme zavolať a prebrať ďalšie kroky a odporúčania.</p>
                        </li>
                    </ol>
                </section>

                 <section id="cta" className="bg-card rounded-lg p-12 text-center border">
                     <h2 className="text-3xl font-bold mb-4 font-headline text-foreground">Začnite svoju cestu k lepším pozíciám ešte dnes.</h2>
                      <Button size="lg" asChild>

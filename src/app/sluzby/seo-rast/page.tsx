        ...
        <div className="bg-space text-light">
             <header className="bg-galaxy py-20 sm:py-32">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-4 text-light font-headline">SEO Balík: Rast</h1>
               ...
               <section className="grid items-center gap-12 md:grid-cols-2 mb-20">
                 ...
                 <section className="mb-20">
                     <Card className="bg-galaxy border-spaceship">
                        <CardHeader>
                            <CardTitle className="text-2xl md:text-3xl font-bold text-center text-light">Čo Rast prináša navyše?</CardTitle>
                        </CardHeader>
                        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-lg pt-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-light">Všetko z balíka Štart</h3>
                                    <p className="text-sm text-rocket">Získavate všetky výhody základného balíka ako pevný základ, na ktorom budeme stavať ďalšie úspechy.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Pokročilá analýza kľúčových slov (do 50)</h3>
                                    <p className="text-sm text-rocket">Rozšírime záber a nájdeme ďalšie príležitosti na oslovenie vašej cieľovej skupiny. Zameriame sa aj na komerčné kľúčové slová.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Technické SEO</h3>
                                    <p className="text-sm text-rocket">Optimalizujeme rýchlosť načítania (Core Web Vitals), štruktúrované dáta, správu presmerovaní a ďalšie kľúčové technické aspekty.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Budovanie 3 spätných odkazov/mesiac</h3>
                                    <p className="text-sm text-rocket">Začneme systematicky a bezpečne budovať autoritu vášho webu prostredníctvom kvalitných odkazov z relevantných zdrojov.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Google Business Profile optimalizácia</h3>
                                    <p className="text-sm text-rocket">Ak máte lokálny biznis, zlepšíme vašu viditeľnosť v lokálnom vyhľadávaní a na Google Mapách, aby vás zákazníci ľahko našli.</p>
                                </div>
                            </div>
                             <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    ...
                                    <p className="text-sm text-rocket font-bold text-lg">349 € / mesiac</p>
                                </div>
                            </div>
                        </CardContent>
                     </Card>
                ...
                <section className="max-w-4xl mx-auto mb-20">
                    ...
                    <ol className="relative border-l border-spaceship">                  
                        <li className="mb-10 ml-6">            
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold text-light">Hĺbkový Audit a Stratégia</h3>
                            <p className="mb-4 text-base font-normal text-rocket">Začíname komplexným auditom vášho webu a konkurencie. Na základe dát vytvoríme jasnú stratégiu a mesačný plán aktivít.</p>
                        </li>
                        <li className="mb-10 ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-light">Mesačná Exekúcia</h3>
                            <p className="text-base font-normal text-rocket">Každý mesiac pracujeme na technickej optimalizácii, on-page úpravách a budovaní spätných odkazov podľa stanoveného plánu.</p>
                        </li>
                        <li className="ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-light">Reporting a Plánovanie</h3>
                            <p className="text-base font-normal text-rocket">Na konci mesiaca dostanete detailný report s výsledkami, analýzou a plánom na ďalší mesiac. Sme vám k dispozícii na pravidelné konzultácie.</p>
                        </li>
                    </ol>
                </section>

                 <section id="cta" className="bg-galaxy rounded-lg p-12 text-center border border-spaceship">
                     <h2 className="text-3xl font-bold mb-4 font-headline text-light">Je čas rásť rýchlejšie ako konkurencia.</h2>
                      <Button size="lg" asChild className="bg-sky hover:bg-night-sky">

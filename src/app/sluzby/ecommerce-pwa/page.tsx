        ...
        <div className="bg-background text-foreground">
            ...
            <main className="container mx-auto py-16 px-4">
                <section id="about-ecommerce-pwa" className="max-w-4xl mx-auto text-center mb-20">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 font-headline text-foreground">Prečo je PWA budúcnosťou E-commerce?</h2>
                ...
                <section id="features" className="mb-20 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <Card className="text-center">
                        <CardHeader className="items-center">
                            ...
                            <CardTitle className="mt-4 text-xl font-semibold text-foreground">Blesková Rýchlosť</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-muted-foreground text-balance">Okamžité načítanie a plynulé prechádzanie produktov zvyšuje spokojnosť zákazníkov a priamo znižuje mieru opustenia košíka. Každá ušetrená milisekunda znamená potenciálne vyšší zisk.</p>
                        </CardContent>
                    </Card>
                        <Card className="text-center">
                        <CardHeader className="items-center">
                            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/10 shadow-lg"><ShoppingCart className="h-8 w-8 text-primary" /></div>
                            <CardTitle className="mt-4 text-xl font-semibold text-foreground">Zážitok Natívnej Aplikácie</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-muted-foreground text-balance">Zákazníci si môžu váš e-shop pridať na plochu, nakupovať offline a dostávať push notifikácie o zľavách, novinkách alebo stave objednávky.</p>
                        </CardContent>
                    </Card>
                        <Card className="text-center lg:col-span-2 xl:col-span-1">
                        <CardHeader className="items-center">
                             <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/10 shadow-lg"><BarChart2 className="h-8 w-8 text-primary" /></div>
                            <CardTitle className="mt-4 text-xl font-semibold text-foreground">Vyššie Konverzie</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-muted-foreground text-balance">Zjednodušený a rýchlejší nákupný proces, personalizácia a efektívny remarketing vedú k výraznému nárastu konverzného pomeru a priemernej hodnoty objednávky.</p>
                        </CardContent>
                    </Card>
                </section>
                 ...
                 <section id="benefits" className="grid items-center gap-12 md:grid-cols-2 mb-20">
                    ...
                    <div>
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 font-headline text-foreground">Kompletné riešenie na mieru</h2>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Dizajn a Vývoj na Mieru</h3>
                             ...
                             <li className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Integrácia Platobných Brán a Dopravy</h3>
                             ...
                             <li className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Pokročilá Správa Produktov a Zákazníkov</h3>
                            ...
                            <li className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">SEO pre E-commerce</h3>
                 ...
                 <section className="max-w-4xl mx-auto mb-20">
                    <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center font-headline text-foreground">Náš Proces Vývoja</h2>
                    <ol className="relative border-l border-border">                  
                        <li className="mb-10 ml-6">            
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold text-foreground">Analýza a Stratégia</h3>
                            <p className="mb-4 text-base font-normal text-muted-foreground">Ponoríme sa do vášho biznisu, analyzujeme konkurenciu a definujeme kľúčové funkcie a používateľské cesty pre váš nový e-shop.</p>
                        </li>
                        <li className="mb-10 ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-foreground">UX/UI Dizajn a Prototyp</h3>
                            <p className="text-base font-normal text-muted-foreground">Vytvoríme intuitívny a vizuálne príťažlivý dizajn zameraný na maximálnu konverziu. Vytvoríme klikateľný prototyp, aby ste si mohli e-shop vyskúšať ešte pred programovaním.</p>
                        </li>
                        <li className="ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-foreground">Vývoj, Nasadenie a Podpora</h3>
                            <p className="text-base font-normal text-muted-foreground">Naprogramujeme, otestujeme a nasadíme váš nový e-shop. Poskytneme vám školenie a dlhodobú technickú podporu pre bezproblémový chod.</p>
                        </li>
                    </ol>
                </section>

                 <section id="cta" className="bg-card border rounded-2xl p-12 text-center">
                     <h2 className="text-3xl font-bold mb-4 font-headline text-foreground">Pripravení predávať viac?</h2>

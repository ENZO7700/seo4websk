        ...
        <div className="bg-space text-light">
             <header className="bg-galaxy py-20 sm:py-32">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-4 text-light font-headline">PWA Business</h1>
               ...
               <section className="grid items-center gap-12 md:grid-cols-2 mb-20">
                 ...
                 <section className="mb-20">
                     <Card className="bg-galaxy border-spaceship">
                        <CardHeader>
                            <CardTitle className="text-2xl md:text-3xl font-bold text-center text-light">Detailné Funkcie Balíka</CardTitle>
                        </CardHeader>
                        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-lg pt-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-light">Neobmedzený počet stránok</h3>
                                    <p className="text-sm text-rocket">Plná flexibilita pre rast vášho obsahu bez akýchkoľvek obmedzení. Pridávajte nové služby, referencie alebo sekcie podľa potreby.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Blogovací systém (CMS)</h3>
                                    <p className="text-sm text-rocket">Jednoducho spravujte a publikujte články, novinky a prípadové štúdie. Budujte si status experta a zlepšujte SEO vďaka kvalitnému obsahu.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Bot className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Push notifikácie</h3>
                                    <p className="text-sm text-rocket">Oslovte zákazníkov priamo na ich zariadeniach s novinkami, akciami alebo dôležitými upozorneniami. Zvýšte mieru návratnosti a angažovanosť.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Pokročilá SEO optimalizácia</h3>
                                    <p className="text-sm text-rocket">Zabezpečíme, aby vaša nová aplikácia bola od začiatku miláčikom vyhľadávačov. Zameriame sa na technické SEO, štruktúrované dáta a optimalizáciu pre mobilné zariadenia.</p>
                                </div>
                            </div>
                             <div className="flex items-start gap-3">
                                <BarChart2 className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Analytické nástroje</h3>
                                    <p className="text-sm text-rocket">Integrácia nástrojov (napr. Google Analytics 4) na sledovanie návštevnosti, správania používateľov a konverzií. Získajte dáta pre lepšie rozhodnutia.</p>
                                </div>
                            </div>
                             <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    ...
                                    <p className="text-sm text-rocket font-bold text-lg">od 2,499 € (jednorazovo)</p>
                                </div>
                            </div>
                        </CardContent>
                     </Card>
                ...
                <section className="max-w-4xl mx-auto mb-20">
                    ...
                    <ol className="relative border-l border-spaceship">                  
                        <li className="mb-10 ml-6">            
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold text-light">Stratégia a Plánovanie</h3>
                            <p className="mb-4 text-base font-normal text-rocket">Začíname hĺbkovým workshopom, kde definujeme ciele, cieľové skupiny, obsahovú stratégiu a kľúčové funkcie vašej novej PWA.</p>
                        </li>
                        <li className="mb-10 ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-light">Dizajn a Vývoj</h3>
                            <p className="text-base font-normal text-rocket">Vytvoríme interaktívny prototyp a po jeho schválení sa pustíme do vývoja aplikácie s dôrazom na čistý kód a najnovšie technológie.</p>
                        </li>
                        <li className="ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-light">Nasadenie a Školenie</h3>
                            <p className="text-base font-normal text-rocket">Aplikáciu nasadíme na produkčný server a detailne vás zaškolíme do používania CMS a všetkých funkcií, aby ste mohli platformu naplno využívať.</p>
                        </li>
                    </ol>
                </section>
                
                 <section id="cta" className="bg-galaxy rounded-lg p-12 text-center border border-spaceship">
                     <h2 className="text-3xl font-bold mb-4 font-headline text-light">Chcete naštartovať Váš online biznis?</h2>

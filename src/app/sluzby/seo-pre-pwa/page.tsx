        ...
        <div className="bg-background text-foreground">
            ...
            <main className="container mx-auto py-16 px-4">
                <section id="about-pwa-seo" className="max-w-4xl mx-auto text-center mb-20">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 font-headline text-foreground">Prečo PWA potrebuje špeciálnu SEO starostlivosť?</h2>
                ...
                <section id="features" className="mb-20">
                     <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center font-headline text-foreground">Naše Kľúčové Oblasti Zamerania</h2>
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                         <Card className="text-center">
                            <CardHeader className="items-center">
                                ...
                                <CardTitle className="mt-4 text-xl font-semibold text-foreground">Mobile-First Indexing</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-muted-foreground text-balance">Optimalizujeme vašu PWA pre mobilné indexovanie, čo je absolútne kľúčové pre Google a spokojnosť rastúceho počtu mobilných používateľov.</p>
                            </CardContent>
                         </Card>
                         <Card className="text-center">
                            <CardHeader className="items-center">
                                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/10 shadow-lg"><Code className="h-8 w-8 text-primary" /></div>
                                <CardTitle className="mt-4 text-xl font-semibold text-foreground">JavaScript SEO</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-muted-foreground text-balance">Zabezpečíme, aby bol váš dynamicky generovaný obsah plne viditeľný a indexovateľný pre vyhľadávače pomocou techník ako Server-Side Rendering (SSR) alebo dynamické renderovanie.</p>
                            </CardContent>
                         </Card>
                         <Card className="text-center">
                            <CardHeader className="items-center">
                                ...
                                <CardTitle className="mt-4 text-xl font-semibold text-foreground">Rýchlosť a Výkon</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-muted-foreground text-balance">Vykonáme hĺbkový audit a odstránime všetky technické prekážky, ktoré bránia vašej PWA v top pozíciách, vrátane optimalizácie Core Web Vitals.</p>
                            </CardContent>
                         </Card>
                    </div>
                </section>
                 ...
                 <section id="benefits" className="grid items-center gap-12 md:grid-cols-2 mb-20">
                     <div>
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 font-headline text-foreground">Náš Prístup k SEO pre PWA</h2>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Renderovanie na strane servera (SSR)</h3>
                             ...
                             <li className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Implementácia štruktúrovaných dát</h3>
                             ...
                             <li className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">Optimalizácia pre Crawl Budget</h3>
                             ...
                             <li className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-foreground">App Shell Model a Service Workers</h3>
                 ...
                 <section id="cta" className="bg-card border rounded-2xl p-12 text-center">
                     <h2 className="text-3xl font-bold mb-4 font-headline text-foreground">Ste pripravení dominovať vo vyhľadávaní?</h2>

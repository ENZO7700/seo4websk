        ...
        <div className="bg-space text-light">
             <header className="bg-galaxy py-20 sm:py-32">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-4 text-light font-headline">SEO Balík: Expert</h1>
               ...
               <section className="grid items-center gap-12 md:grid-cols-2 mb-20">
                 ...
                 <section className="mb-20">
                     <Card className="bg-galaxy border-spaceship">
                        <CardHeader>
                            <CardTitle className="text-2xl md:text-3xl font-bold text-center text-light">Čo získate s balíkom Expert?</CardTitle>
                        </CardHeader>
                        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-lg pt-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-rocket">Staviame na pevných základoch a pridávame stratégie pre budovanie osobnej značky.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Komplexná analýza kľúčových slov (do 100)</h3>
                                    <p className="text-sm text-rocket">Zameriame sa na kľúčové slová, ktoré potvrdzujú vašu expertízu a priťahujú vysoko relevantných klientov.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Budovanie 5 spätných odkazov/mesiac</h3>
                                    <p className="text-sm text-rocket">Cielený link building zameraný na získavanie odkazov z rešpektovaných portálov vo vašom odbore a hosťovské blogovanie.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Konzultácie (1 hod/mesiac)</h3>
                                    <p className="text-sm text-rocket">Pravidelné stretnutia, kde preberieme obsahovú stratégiu, výsledky a ďalšie kroky pre posilnenie vašej značky.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    <h3 className="font-bold text-light">Základná optimalizácia sociálnych sietí</h3>
                                    <p className="text-sm text-rocket">Poradíme vám, ako prepojiť SEO so sociálnymi sieťami (najmä LinkedIn) a ako konzistentne budovať vašu online prítomnosť.</p>
                                </div>
                            </div>
                             <div className="flex items-start gap-3">
                                <Check className="h-6 w-6 text-aurora mt-1 flex-shrink-0" />
                                <div>
                                    ...
                                    <p className="text-sm text-rocket font-bold text-lg">449 € / mesiac</p>
                                </div>
                            </div>
                        </CardContent>
                     </Card>
                ...
                <section className="max-w-4xl mx-auto mb-20">
                    ...
                    <ol className="relative border-l border-spaceship">                  
                        <li className="mb-10 ml-6">            
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold text-light">Definovanie expertízy a cieľov</h3>
                            <p className="mb-4 text-base font-normal text-rocket">Na začiatku si definujeme vašu unikátnu pozíciu na trhu, kľúčové oblasti expertízy a ciele budovania osobnej značky.</p>
                        </li>
                        <li className="mb-10 ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-light">Obsahový plán a exekúcia</h3>
                            <p className="text-base font-normal text-rocket">Vytvoríme publikačný plán (blog, príspevky na LinkedIn, prípadové štúdie) a pomôžeme vám s tvorbou obsahu, ktorý vás ukáže ako autoritu.</p>
                        </li>
                        <li className="ml-6">
                            ...
                            <h3 className="mb-1 text-lg font-semibold text-light">Networking a budovanie autority</h3>
                            <p className="text-base font-normal text-rocket">Systematicky budujeme spätné odkazy a hľadáme príležitosti na zviditeľnenie (rozhovory, podcasty, hosťovanie na webinároch).</p>
                        </li>
                    </ol>
                </section>

                 <section id="cta" className="bg-galaxy rounded-lg p-12 text-center border border-spaceship">
                     <h2 className="text-3xl font-bold mb-4 font-headline text-light">Pripravení zarábať na svojom mene?</h2>
                      <Button size="lg" asChild className="bg-sky hover:bg-night-sky">

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/semantic-analyzer`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  ...
  const blogPosts = [
    {
     ...
     {
      url: `${baseUrl}/blog/preco-je-pwa-buducnost-webu`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.7,
    },
    {
      url: `${baseUrl}/blog/pripadova-studia-zdvojnasobenie-organiky`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.7,
    },
    {
      url: `${baseUrl}/blog/5-chyb-v-technickom-seo`,
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.7,
    },
